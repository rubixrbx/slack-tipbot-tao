...
module.exports = { 
    ...
    '\t\t_@DashBot send 0.1 TAO to @someone_ \n' +
    '\t\t_aliases: give, tip_ \n' +
    ...
    '\t\t_@DashBot withdraw 1 TAO to Xdice8EMZmqKvrGE4Qc9bUFf9PX3xaYDp!_',
    ...
    '\t\t_@DashBot 0.03 TAO to GBP_ \t or \t _@DashBot 15 EURO to DASH_\n',
    ...
    // 'RainRecieved': ':droplet: \n You got splashed with a Tao raindrop of ',
    ...
    // SUN
        ...
        'SunThresholdNotSet': 'Dear Tao God, the Sun threshold isn\'t set yet. \n' +
    ' You can do that with the *sun threshold _amount_* command.',
    // 'SunTimer': 'Sunshine will be checked every *',
    // 'SunTimerUnit': ' minute(s)*',
    // 'SunTimerNotSet': 'Dear Tao God, the sun timer is not set yet.\n' +
    // ' You can do that with the *sun timer _minutes_* command.',
        ...
        'SunReqDonation3': '_ will be redistributed as _sunrays_ (aka free Tao).',
        'SunEmpty': ':sun_behind_cloud:no sunrays available to cast. :disappointed:',
        'SunRecieved': 'As reward of tipping your fellow Tao user(s) you received a sunray of ',
